...
/*
 mex -DMATLAB GCC=/usr/bin/gcc-4.9 Test_SockerWrapper.c CFLAGS="-std=c11 -fPIC" ../../../Display/Source/Display.c ../../Source/SocketWrapper.c ../../Source/Message.c -I../../../../Include/ -L/usr/local/MATLAB/R2017b/sys/os/glnxa64/
*/
